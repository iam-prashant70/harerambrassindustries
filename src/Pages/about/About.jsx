  ...
  return (
    <>
      ...
      <section className="features-section">
        ...
        <div className="features-grid" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "2rem", marginTop: "2rem" }}>
          {features.map(feature => (
            <div key={feature.id} className="feature-card" style={{ width: "90vw", maxWidth: "400px", textAlign: "center", background: "#1e1e1e", borderRadius: "1rem", padding: "2rem", color: "white" }}>
