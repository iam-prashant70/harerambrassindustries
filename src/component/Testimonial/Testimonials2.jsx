...
export default function Testimonials2() {
  ...
  return (
    <section id="testimonials" className="testimonialsdesign">
      <h1 className='section-title' style={{marginBottom : "7vh"}}>What Our Clients Say</h1>

      <div className="container">
        <div className="proslid slider-wrapper" ref={sliderRef}>
          <div className="slider">
            {testimonials.map((testimonial, index) => (
              <div className="reviewcard" key={`testimonial-${testimonial.name}-${index}`}>
